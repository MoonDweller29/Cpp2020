...
int main(int argc, char **argv) {
	...
	std::cout << "Time check basic map = " << check(database, dict1) << std::endl;
	std::cout << "Time check improved map = " << check(database, dict2) << std::endl;

	// for (int i = 0; i < database.len(); ++i)
	// {
	// 	std::cout << database.getName(i) << std::endl;
	// }
